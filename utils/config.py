...
# OASIS
# parser.add_argument("--atlas_file", type=str, help="gpu id number",
#                     dest="atlas_file", default='../Dataset/OASIS/fixed.nii.gz')
# IXI
# parser.add_argument("--atlas_file", type=str, help="gpu id number",
#                     dest="atlas_file", default='../Dataset/IXI/atlas.pkl')
# AbdomenCT_CT
# parser.add_argument("--atlas_file", type=str, help="gpu id number",
#                     dest="atlas_file", default='../Dataset/AbdomenCT_CT/fixed.nii.gz')
...
parser.add_argument("--result_dir", type=str, help="results folder",
                    dest="result_dir", default='./Result_image')
...
# OASIS 
# parser.add_argument("--train_dir", type=str, help="data folder with training vols",
#                     dest="train_dir", default="../Dataset/OASIS/Train")
# IXI
# parser.add_argument("--train_dir", type=str, help="data folder with training vols",
#                     dest="train_dir", default="../Dataset/IXI/Train")
# AbdomenCT_CT
# parser.add_argument("--train_dir", type=str, help="data folder with training vols",
#                     dest="train_dir", default="../Dataset/AbdomenCT_CT/Train")
...
parser.add_argument("--alpha", type=float, help="regularization parameter",
                    dest="alpha", default=4)  # recommend 4 for ncc, 0.04 for mse
...
# OASIS 
# parser.add_argument("--test_dir", type=str, help="test data directory",
#                     dest="test_dir", default='../Dataset/OASIS/Test')
# parser.add_argument("--label_dir", type=str, help="label data directory",
#                     dest="label_dir", default='../Dataset/OASIS/label')
# IXI
# parser.add_argument("--test_dir", type=str, help="test data directory",
#                     dest="test_dir", default='../Dataset/IXI/Test')
# AbdomenCT_CT 
# parser.add_argument("--test_dir", type=str, help="test data directory",
#                     dest="test_dir", default='../Dataset/AbdomenCT_CT/Test')
# parser.add_argument("--label_dir", type=str, help="label data directory",
#                     dest="label_dir", default='../Dataset/AbdomenCT_CT/label')
